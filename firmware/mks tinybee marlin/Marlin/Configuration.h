...
#define STRING_CONFIG_H_AUTHOR "(Rodrigo Y, 20221227)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Voron trident"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  23.53,  22.20 }
    #define DEFAULT_Ki_LIST {   2.64,   1.08 }
    #define DEFAULT_Kd_LIST { 52.52, 114.00 }
  #else
    #define DEFAULT_Kp 23.53
    #define DEFAULT_Ki 2.64
    #define DEFAULT_Kd 52.52
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 75.32
  #define DEFAULT_bedKi 6.03
  #define DEFAULT_bedKd 626.80
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 480.0, 420 }
 ...
 */
// #define Z_MIN_PROBE_PIN 22 // Pin 32 is the RAMPS default
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + Y_MIN_POS
